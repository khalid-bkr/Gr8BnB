...
<body>
      <jsp:include page="NavBar.jsp"></jsp:include>
   	...
   	<form  action="calendardelete" method="post" class="container">
		...
		<p <c:if test="${messages.disableSubmit}">style="display: none !important"</c:if> class="d-flex justify-content-center">
			<input id="calendarid" name="calendarid" placeholder="Calendar ID" class="search-box" value="${fn:escapeXml(param.calendarid)}">
		</p>
