...
<title>Delete a Host Rating</title>
</head>
<body>
<jsp:include page="NavBar.jsp"></jsp:include>

	
	<form  action="hostratingdelete" method="post" class="container">
		...
		<p <c:if test="${messages.disableSubmit}">style="display: none !important"</c:if> class="d-flex justify-content-center">
			<input id="hostratingid" name="hostratingid" placeholder="Host Rating ID" class="search-box" value="${fn:escapeXml(param.hostratingId)}">
		</p>
